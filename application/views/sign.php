            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" action="sign_up" method="post" novalidate>
                    ...
                    <div class="col-12">
                      <label for="yourPassword" class="form-label">Numero phone</label>
                      <input type="text" name="numero" class="form-control" id="yourPassword" required>
